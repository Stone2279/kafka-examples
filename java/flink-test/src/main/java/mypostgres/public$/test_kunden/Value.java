...
public class Value extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3140054883823878613L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Value\",\"namespace\":\"mypostgres.public.test_kunden\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"int\",\"connect.default\":0},\"default\":0},{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"country\",\"type\":[\"null\",\"string\"],\"default\":null},{\"name\":\"address\",\"type\":[\"null\",\"string\"],\"default\":null}],\"connect.name\":\"mypostgres.public.test_kunden.Value\"}");
   ...
   */
  public Value(java.lang.Integer id, java.lang.CharSequence name, java.lang.CharSequence country, java.lang.CharSequence address) {
    this.id = id;
    this.name = name;
   ...
   */
  public static mypostgres.public$.test_kunden.Value.Builder newBuilder() {
    return new mypostgres.public$.test_kunden.Value.Builder();
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static mypostgres.public$.test_kunden.Value.Builder newBuilder(mypostgres.public$.test_kunden.Value.Builder other) {
    if (other == null) {
      return new mypostgres.public$.test_kunden.Value.Builder();
    } else {
      return new mypostgres.public$.test_kunden.Value.Builder(other);
    }
  }
   ...
   * @return A new Value RecordBuilder
   */
  public static mypostgres.public$.test_kunden.Value.Builder newBuilder(mypostgres.public$.test_kunden.Value other) {
    if (other == null) {
      return new mypostgres.public$.test_kunden.Value.Builder();
    } else {
      return new mypostgres.public$.test_kunden.Value.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Value>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(mypostgres.public$.test_kunden.Value.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(mypostgres.public$.test_kunden.Value other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder setCountry(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder clearCountry() {
      country = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder setAddress(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public mypostgres.public$.test_kunden.Value.Builder clearAddress() {
      address = null;
